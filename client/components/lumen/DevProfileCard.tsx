...
export default function DevProfileCard({ name, role, photo, github, linkedin }: DevProfileCardProps) {
  return (
      ...
      <div className="devcard-card">
        <div className="devcard-info">
          <div className="devcard-avatar">
            {photo ? (
              <img src={photo} alt={`${name} avatar`} className="devcard-avatar-img" />
            ) : (
              <svg viewBox="0 0 24 24" aria-hidden className="devcard-avatar-fallback">
          ...
          <ul className="devcard-social">
            ...
            {linkedin && (
              <li className="devcard-social-icon">
                <a href={linkedin} target="_blank" rel="noreferrer" aria-label={`${name} LinkedIn`}>
                  <Linkedin size={20} />
                </a>
              </li>
            )}
